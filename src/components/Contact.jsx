...
import { FaEnvelope, FaMapMarkedAlt, FaPhone, FaGithub, FaLinkedin, FaPaperPlane } from 'react-icons/fa';
...
const Contact = () => {
  ...
  return (
<div className="bg-black/60 text-white py-20 backdrop-blur-sm rounded-t-3xl" id="contact">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            ...
            <div className='mb-4 mt-8'>
              ...
              <a href="mailto:amanshaw871@gmail.com" className='hover:underline'>
            ...
            <div className='mb-4'>
              <FaGithub className='inline-block text-gray-300 mr-2' />
              <a href="https://github.com/Amanshaw445" target="_blank" rel="noopener noreferrer" className="hover:underline">
            ...
            <div className='mb-4'>
              ...
              <a href="https://linkedin.com/in/amanshaw445" target="_blank" rel="noopener noreferrer" className="hover:underline">
  ...
  {/* Gmail Field */}
  <div>
    <label htmlFor="gmail" className="block mb-2">Email</label>
    <input
      name="gmail"
      type="email"
      className="w-full p-2 rounded bg-gray-800 border border-gray-600 focus:outline-none focus:border-green-400"
