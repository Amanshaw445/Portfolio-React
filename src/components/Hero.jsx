      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-6 block md:hidden">
          <button
            ...
            className="bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold px-5 py-2 rounded-full transition-transform hover:scale-105 hover:brightness-110"
          >
            View Resume
          </button>
        </div>
